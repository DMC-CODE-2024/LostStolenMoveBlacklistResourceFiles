...
mkdir -p ${LOG_HOME}/${MODULE_FOLDER}/${MODULE_NAME}

cd ${APP_HOME}/${MODULE_FOLDER}/${MODULE_NAME}

ln -s ${RELEASE_HOME}/${MODULE_NAME}_${MODULE_VERSION}.jar ${MODULE_NAME}.jar

mv ${RELEASE_PATH}/binary/${MODULE_FOLDER}/${MODULE_NAME}/${MODULE_VERSION}/application.properties ${APP_HOME}/${MODULE_FOLDER}/${MODULE_NAME}
